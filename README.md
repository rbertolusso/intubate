...
In fact, it may create a division line of two clearly separated cultures, that I will call, for the lack of better names, the "traditionalists"
and the "modernists" (they could be the "modeldatas" and the "datamodels",
whichever you prefer)
 
The aim of `intubate` is to provide an easy alternative so nobody has to change
...
(Did you think I would work more that you?)
...
do *this* to *yourself*.
 ...
 I am unaware of. But the point is that they are, well,
...
(After all, I am a statistician... Please skip it if you still believe in Santa.)
...
the fitting procedure is no other thing of that an optimization technique
