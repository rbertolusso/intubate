---
title: "intubate <||> 1.3.0"
author: "Roberto Bertolusso"
date: "September 8, 2016"
output: rmarkdown::html_document
vignette: >
  %\VignetteIndexEntry{intubate <||> 1.3.0}
...
* Also using parameters in their preferred order.
  ...
  at least for now (only plot shown):
...
For this example, we will use the code provided in the vignette of
package `survey`, that can be found in:

<https://cran.r-project.org/web/packages/survey/vignettes/survey.pdf>

We start by illustrating the original code on the vignette (output not shown):
...
Below we illustrate two strategies of using intubOrders.
